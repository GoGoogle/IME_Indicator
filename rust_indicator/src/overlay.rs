...
impl IndicatorOverlay {
    ...
    pub fn update(&self, x: i32, y: i32, is_chinese: bool, is_caps: bool, caret_h: i32) {
        ...
        unsafe {
            ...
            let bmi = BITMAPINFO { bmiHeader: BITMAPINFOHEADER { biSize: std::mem::size_of::<BITMAPINFOHEADER>() as u32, biWidth: self.size, biHeight: self.size, biPlanes: 1, biBitCount: 32, biCompression: BI_RGB.0, ..Default::default() }, ..Default::default() };
